...
class sixpg extends StatefulWidget {
  const sixpg({super.key});

  @override
  State<sixpg> createState() => _sixpgState();
}

class _sixpgState extends State<sixpg> {
  @override
      ...
      child: Scaffold(
        body: Column(
          children: [
            ...
            SizedBox(height: 60,),
            Image.asset('assets/image/body-weight-scales-icon 1.png'),
            SizedBox(
              height: 40,
            ),
            Container(
